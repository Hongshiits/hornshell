...
void init_varsys_func(vector<string> &base_func_name,vector<string(*)(vector<string>)> &base_func_addr){
    base_func_name.push_back("show_var");
	base_func_addr.push_back(show_var);


    base_func_name.push_back("long_var");
	base_func_addr.push_back(creat_long_var);

	base_func_name.push_back("set_value");
	base_func_addr.push_back(set_value);

	base_func_name.push_back("show_value");
	base_func_addr.push_back(show_value);
